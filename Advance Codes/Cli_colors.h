...
#define DECLARE_TERMINAL_DESIGN(__value) L"\033[" #__value "m"
...
namespace CliColors
{
    #define CREATE_CLI_COLOR(__name) constexpr const wchar_t *const __name = CLI_COLOR_##__name
    #define CREATE_CLI_DESIGN(__design) constexpr const wchar_t *const __design = CLI_DESIGN_##__design
